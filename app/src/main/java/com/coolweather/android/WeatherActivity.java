...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        carWashCText = (TextView) findViewById(R.id.car_wash_text);
    ...
    private void requestWeather(String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+ weatherId+"&key=8a03695a0e7e4af08f188e7eb2d05d77";
